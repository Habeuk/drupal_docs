...
<div class="summary d-flex flex-wrap">
  <MonComposant href="./docs/support-licence.html">
    <template #icone>
    ...
    <template #header>
     Support et licence du theme
    </template>
  </MonComposant>
  <MonComposant href="./docs/installation-new.html">    
    <template #header>
     Installation
    </template>
  </MonComposant>
  <MonComposant href="./docs/configuration-theme.html">
    <template #icone>
  ...
  <MonComposant href="./docs/commerce/manage-store.html">
    <template #icone>
